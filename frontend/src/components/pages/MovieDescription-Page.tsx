...
function MovieDescription() {
  ...
  // Build dynamic background styling
  ...
  // Build movie details section
  const movieDetails = (
    <div className="flexbox items-center">
      <p className="text-6xl font-bold wrap-normal movie-title">
        {movie.title}
      </p>
      <p className="text-xl wrap-normal movie-title movie-subtitle">
        {movie.release_date}
      </p>
      <MovieRatings
